        ...
        <div className="flex flex-col items-center justify-center min-h-screen w-full">
            ...
            <div className="w-70 mx-auto aspect-[16/9] mb-4">
                <motion.div animate={{ y: [-5, 5] }} transition={{ repeat: Infinity, repeatType: "reverse", duration: 3, ease: "easeInOut" }}>
                    <Image src="/ss-pictures/Astronaut.jpg" alt="Astronaut floating in space" className="object-cover rounded-lg w-full h-full" width={1920} height={1080} sizes="(max-width: 640px) 100vw, (max-width: 768px) 80vw, 50vw" priority />
                </motion.div>
            </div>
